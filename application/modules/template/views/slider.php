    ...
    <div class="row align-items-center">
      <div class="col-lg-7 col-md-12 hero-content-col">
        ...
        <div class="hero-top-badge d-inline-flex align-items-center gap-2">
          ...
          <span>YOUR CARGO. OUR RESPONSIBILITY.</span>
        </div>
        ...
        <h1 class="hero-title">
          ...
          Solutions That
          <span class="highlight-orange">Move Your Business
          Forward</span>
        </h1>
        
        <!-- Description -->
        <p class="hero-desc">
          End-to-end logistics and supply chain solutions designed for speed, safety, and reliability.
        </p>
        ...
        <div class="hero-actions">
          <a href="<?= site_url('about-us') ?>" class="btn-hero-orange">
            <span>About Us</span>
            <i class="bi bi-arrow-right"></i>
          </a>
          <a href="<?= isset($phonehtml) ? $phonehtml : 'tel:+' ?>" class="btn-hero-outline">
            <span>Call Now</span>
